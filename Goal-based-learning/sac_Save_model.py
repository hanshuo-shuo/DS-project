...
if __name__ == "__main__":
    ...
    if resume is True:
        ...
        qf1_target.load_state_dict(checkpoint['qf1_target_state'])
        qf2_target.load_state_dict(checkpoint['qf2_target_state'])
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            torch.save({
                ...
                'qf1_target_state': qf1_target.state_dict(),
                'qf2_target_state': qf2_target.state_dict(),
