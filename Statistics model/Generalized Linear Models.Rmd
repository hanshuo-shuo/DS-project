...
```{r}
PI <- c(.001, .01, .05, .1, .3, .5, .7, .9, .95, .99, .999)
Variance <- round(PI*(1-PI), digits= 4)
df <- data.frame(cbind(PI, Variance))
df
```
...
The problem arises when there's extreme value of $\pi$. Then the variance get very small and hence the inverse of variance blows up.

### 14.3

<img src="14.3.png" alt="drawing" width="800"/>

### 14.6

<img src="14.6.png" alt="drawing" width="800"/>

### 15.2

a)  

<img src="15.2a.png" alt="drawing" width="800"/>

b)  

<img src="15.2b.png" alt="drawing" width="800"/>

c)  

<img src="15.2c.png" alt="drawing" width="800"/>

### 15.4

<img src="15.4.png" alt="drawing" width="800"/>
